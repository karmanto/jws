...
#define start_kalender  40
#define posisi_kalender 0
...
int sw_kalender = 0;
byte disp_segmen[50] = {1, 2, 4, 8, 16, 32, 64, 128,
...
void ScanDMD()
{
  ...
  if (posisi_kalender == 0) {
    //isya
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    sen(~disp_segmen[(start_kalender + 4) + pos_scan], true, ~disp_segmen[isya_jam_pul + pos_scan], true);
    //maghrib
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    sen(~disp_segmen[start_kalender + pos_scan], true, ~disp_segmen[maghrib_jam_pul + pos_scan], true);
    //ashar
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    ...
    //isya
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    sen(~disp_segmen[thn_rib + pos_scan], true, ~disp_segmen[isya_jam_pul + pos_scan], true);
    //maghrib
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    sen(~disp_segmen[tgl_pul + pos_scan], true, ~disp_segmen[maghrib_jam_pul + pos_scan], true);
    //ashar
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    sen(~disp_segmen[(start_kalender + 4) + pos_scan], true, ~disp_segmen[asar_jam_pul + pos_scan], true);
    //dhuhur
    sen(lok1[pos_scan], false, lok1[pos_scan], false);
    sen(~disp_segmen[start_kalender + pos_scan], true, ~disp_segmen[dhuhur_jam_pul + pos_scan], true);
    //subuh
    sen(~disp_segmen[jam_pul], false, lok1[pos_scan], false);
    sen(~disp_segmen[jam_sat], false, ~disp_segmen[subuh_jam_pul + pos_scan], true);
    //imsya
...
void tampil() {
  ...
  if (sw_kalender == 0) {
    disp_segmen[start_kalender] = huruf[hari][0];
    disp_segmen[start_kalender + 1] = huruf2[hari][1];
    disp_segmen[start_kalender + 2] = huruf[hari][2];
    disp_segmen[start_kalender + 3] = huruf2[hari][3];
    disp_segmen[start_kalender + 4] = huruf[hari][4];
    disp_segmen[start_kalender + 5] = huruf2[hari][5];
    disp_segmen[start_kalender + 6] = huruf[hari][6];
    disp_segmen[start_kalender + 7] = huruf2[hari][7];
  } else {
    disp_segmen[start_kalender] = angka[10];;
    disp_segmen[start_kalender + 1] = angka2[10];
    disp_segmen[start_kalender + 2] = angka[10];
    disp_segmen[start_kalender + 3] = angka2[10];
    disp_segmen[start_kalender + 4] = angka[10];
    disp_segmen[start_kalender + 5] = angka2[10];
    disp_segmen[start_kalender + 6] = angka[10];
    disp_segmen[start_kalender + 7] = angka2[10];
  }
